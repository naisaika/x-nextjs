                ...
                <li key={title.id}>
                    ...
                    {title.id === 0 && 
                        <p className={styles.contentsText}>
                            自分の強みや弱みは、過去の成功体験や失敗体験を基にすると見つけやすくなります。<br/>
                            また、周りの人から客観的な意見を求めてみるのも良いでしょう。<br/>
                            強みは、仕事を通じて習得したスキルや成果へ結びつけることのできるスキルの中で3～5つに絞り込みを行い、それぞれに紐づく経験や実績を用意してまとめます。<br></br>
                            一方で、弱みはただマイナスな印象を与えてしまうものを避け、ポジティブに捉えて変換ができるものを選びます。<br/>
                            克服のために意識していることや具体的なエピソードを添えることで印象をアップさせることができます。<br/>
                        </p> 
                    }
                    {title.id === 1 && 
                        <>
                            <p className={styles.contentsText}>
                                強みや弱みも踏まえ、応募先の企業で活用できるスキルや経験を過去や今後のビジョンと結びつけて具体的にアピールします。<br/>
                                なぜその企業を応募したのか？を明確にし、入社をしたいという意思がしっかりと伝わるようにする必要があります。<br/>
                                自分目線ではなく企業目線の立場でどんなことに貢献できるのかを盛り込み、企業の募集ニーズに応えられる内容にします。<br/>
                                未経験の業界へ転職する場合は、その具体的理由を述べましょう。<br/>
